...
\begin{Table}{l X}
  ...
  %Exploration & Roll on the Library's ``hidden lore" discovery table, if it has one. \\
...
% \textit{Scrolls} are created as independent items that are treated as if they were a Tome of 2 Folios.
...
\begin{Table}{l c X}
  ...
  Map & 2 & Record the geographic layout of a location or region, including all spatial facts a player would require to physically navigate the depicted region, such as sublocations, environmental hazards, etc. \\
\end{Table}
