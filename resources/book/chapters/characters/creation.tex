...
\begin{Example}
  ...
  \textbf{Size:} Normal, \textbf{Move:} 3"
  ...
  \textbf{Racial Traits:}
  \begin{itemize}
    \item +2 to any Attribute (chosen after rolling Attributes)
  \end{itemize}
...
\begin{itemize}
  \item Add a new passive perk. (See Appendix A: Perks)
  \item Add a new action ability. (See Appendix B: Abilities)
  \item Add a new basic spell. (See Appendix D: Spells)
...
%  \vspace{0.4em}
%
%  A good approach might be to have characters level-up during \textit{downtime} 
%  between coherent missions.
%\end{DesignerNote}
...
\begin{DesignerNote}
  ...
  instead of hoarding everything they come across.
...
they may fill all storage slots with standard items (see Appendix F)
that are representative of their backstory.
...
\section{8. Factions \& Religion}
At the GM's discretion, when a character is created, 
they may join a faction that is appropriate to their background.

\vspace{0.4em}

If the campaign is using religion, then at the GM's discretion, when a character is created, 
they may join a religion that is appropriate to their background.

\vspace{0.4em}

By default, a character belonging to a faction or religion begins at +1 Loyalty,
although this may be changed at the GM's discretion, as appropriate to the character's background.

\vspace{0.4em}

See Chaoter 9: Loyalty: Factions \& Religion.
