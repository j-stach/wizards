...
\section{Die Classes}
In W.I.Z.A.R.D.S., each type of die serves a distinct role (pun intended).
% Makes it easy to identify rolls and remember ability roll sequence
...
to allow a player character to act outside of their explicit 
skills and abilities, in service of the plot.

\vspace{0.4em}

When a player describes the character's intended actions and outcome,
the GM considers the difficulty of the attempted action in the context of the situation,
