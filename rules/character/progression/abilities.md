...
|Dodge |w5, a5|Self| You gain 1 re-roll that may be used on any clash (d6) roll made before the start of your next turn.|
|Conserve |w5, r5|Self| If your next action would consume resources from a pool (e.g., mana), it consumes one less instead.|
...
|Push |a5, s5|Base| Clash (d6) with a character that is in base contact and is *similar size* or *smaller*. If you win, roll `d10`: On a `1-8`, the target *staggers* up to `1"` radially away from you; On a `9+`, the target *staggers* up to `1"` and is knocked prone, taking light (d4) fall damage. If the target's path of movement during stagger crosses the base of another unit, you may have the target make a free Push action against the other unit. This free Push loses advantage.|
